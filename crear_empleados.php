...
<div class="container">
    <br>
    <h1>Registro de Nuevo Empleados</h1>
    <br>
    <form action="guardar_empleados.php" method="POST">
        <div class="form-group">
            <label>DNI:</label>
            <input class="form-control" type="" name="dni">
        </div>
        <div class="form-group">
            <label>Nombres:</label>
            <input class="form-control" type="" name="nombres">
        </div>
        <div class="form-group">
            <label>Apellidos:</label>
            <input class="form-control" type="" name="apellidos">
        </div>
        <div class="form-group">
            <label>Sexo(F/M):</label>
            <input class="form-control" type="" name="sexo">
        </div>
        <div class="form-group">
        ...
        <div class="form-group">
            ...
            <input class="form-control" type="" name="id_perfil">
        </div>
