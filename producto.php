...
<main>
    <div class="container">
        <br><br>
        <h1>Productos</h1>
        <a type="button" class="btn btn-primary" href="crear_producto.php">Crear Producto</a>
        <br><br>
        <div class="card">
            <table class="table table-bordered">
                ...
                while ($filas = $gsent->fetch(PDO::FETCH_ASSOC)) {
                    ...
                    <tr>
                        ...
                        <td><a href='producto_editar.php?xid_product=<?php echo $filas['id_producto'] ?>'>EDITAR</a></td>
                        <td><a href='producto_eliminar.php?xid_product=<?php echo $filas['id_producto'] ?>' onclick="return confirm('¿Estas seguro que deseas eliminar?');">ELIMINAR</a></td>
                    </tr>
                    <?php
                }?>
