...
<div class="container">
    <br>
    <h1>CREAR TURNO PARA VENDEDORES</h1>
    <br>
    <form action="guardar_turnovendedores.php" method="POST">
        <div class="form-group">
            <label>ID Turno:</label>
            <input class="form-control" type="" name="turno">
        </div>
        <div class="form-group">
            <label>ID Empleado:</label>
            <input class="form-control" type="" name="empleado">
        </div>
